    ...
    public partial class Cancellations : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (userSet.Tables[0].Rows.Count > 0)
            {
                ...
                protected void Button5123_Click(object sender, EventArgs e)
        {
            int number = MakeApproved();
            if (number > 0)
            {
        ...
        public int MakeApproved()
        {
            int number = 0;
            String connection = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            OleDbConnection dbCon = new OleDbConnection(connection);
            string sqlCom = "UPDATE Booking SET Approved = true WHERE ([Cancelled] = true)";
